...
<header class="header">
    ...
    <nav class="header__nav">
        <ul class="header-list">
            <li class="header-list__item"><a class="header-list__link " href="<?php echo get_permalink(7); ?>">ABOUT</a>
            </li>
            ...
            <li class="header-list__item"><a class="header-list__link"
                    href="<?php echo get_permalink(12); ?>">CONTACT</a></li>
        </ul>
    </nav>
</header>
<?php else : ?>
<header class="header">
    ...
    <nav class="header__nav">
        <ul class="header-list">
            ...
            <li class="header-list__item"><a class="header-list__link under-page"
                    href="<?php echo get_permalink(7); ?>">ABOUT</a>
            </li>
            ...
            <li class="header-list__item"><a class="header-list__link under-page"
                    href="<?php echo get_post_type_archive_link('works'); ?>">WORKS</a></li>
            <li class="header-list__item"><a class="header-list__link under-page"
                    href="<?php echo get_permalink(12); ?>">CONTACT</a>
            </li>
        </ul>
    </nav>
</header>
